...
let myPrevDate = new Date();
// console.log(myPrevDate.toString());
// console.log(myPrevDate.toLocaleDateString());
// console.log(myPrevDate.toJSON());
// console.log(myPrevDate.toISOString());
